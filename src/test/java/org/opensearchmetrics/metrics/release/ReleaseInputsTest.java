...
public class ReleaseInputsTest {
    ...
    public void testGetAllReleaseInputs() {
        ...
        assertEquals(27, releaseInputs.length);
        ...
        assertEquals(ReleaseInputs.VERSION_1_3_15, releaseInputs[21]);
        assertEquals(ReleaseInputs.VERSION_1_3_16, releaseInputs[22]);
        assertEquals(ReleaseInputs.VERSION_1_3_17, releaseInputs[23]);
        assertEquals(ReleaseInputs.VERSION_1_3_18, releaseInputs[24]);
        assertEquals(ReleaseInputs.VERSION_1_3_19, releaseInputs[25]);
        assertEquals(ReleaseInputs.VERSION_1_3_20, releaseInputs[26]);
    }
